...
final class HomeViewController: UIViewController{
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            bigTitle.trailingAnchor.constraint(equalTo: view.trailingAnchor,constant: -100),
            ...
            smallTitle.trailingAnchor.constraint(equalTo: view.trailingAnchor,constant: -100),
